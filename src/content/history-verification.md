# The Asterion - History Verification Notes

This file is internal and must not be rendered publicly.

For each public history entry, confirm the following before marking as approved: exact event title, date, venue, city, role, institution, project shown, project ownership, collaborators, source, and publication approval.
...
| Contemporary Istanbul Foundation | 2022, exact dates required | Istanbul | Talk / panel participant | Contemporary Istanbul Foundation | N/A | Public programme contribution | Source required | Pending |
| Beyond Istanbul | 2022, exact date required | Four Seasons Sultanahmet | Project presentation | Four Seasons Sultanahmet programme | Beyond Istanbul | Historical project reference | Source required | Pending |
| Borusan Contemporary - Water Reverie / Dus Suda | 2021, exact dates required | Borusan Contemporary | Connected media work | Borusan Contemporary | Water Reverie / Dus Suda | Preserve artist, institution and curatorial credits | Source required | Pending |
| Munich Fabric Start - VR Denim Journey | 2021, exact date required | Munich | International premiere | ORTA Anadolu / Munich Fabric Start | VR Denim Journey | Historical collaboration reference | Source required | Pending |
| Contemporary Istanbul AR project | 2021, exact date required | Istanbul | AR project contribution | Gallery Perrotin, Julio Le Parc Studio, Globart | AR project | Scope and credits require verification | Source required | Pending |
| Public Talk Programme | 2021, exact dates required | Multiple venues | Speaker | AURA Istanbul, Robert College Alumni Association, Rotary Istanbul, Cercle d'Orient | N/A | Public programme contribution | Source required | Pending |
| Venice VR Expanded - La Biennale di Venezia | 2020, exact date required | Online / venue format to be confirmed | Participation under Muse VR | Soho House, Istanbul Planning Agency | Programme participation | Do not imply competition status unless confirmed | Source required | Pending |
| Sonar Istanbul workshop | 2020, exact date required | Istanbul | Workshop leader | Sonar Istanbul | N/A | Workshop on interactive narratives and immersive media | Source required | Pending |
